                      ...
                      <div className="p-8">
                            ...
                            {proj.iconLists.map((icon, idx) => (
                              ...
                              >
                                ...
                                {proj.iconNames && proj.iconNames[idx] && (
                                  <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-purple px-3 py-1.5 rounded-lg text-white text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
                                    {proj.iconNames[idx]}
                                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-purple" />
                                  </div>
                                )}
                              </div>
                            ))}
                        ...
                        <div className="flex gap-4">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl bg-purple hover:bg-purple/90 text-white font-semibold transition-colors"
                          >
